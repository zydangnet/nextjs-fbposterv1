...
// 1. KHỞI TẠO PRISMA CLIENT (Sử dụng global pattern)
let prisma;
if (process.env.NODE_ENV === 'production') {
  prisma = new PrismaClient();
} else {
  // Development: Sử dụng global instance để tránh hot-reload tạo nhiều kết nối
  if (!global.prisma) {
    ...
    try {
        await prisma.content.update({
            ...
            data: {
                ...
                // Cập nhật ID bài viết mới nhất vào IDFbPost
                IDFbPost: fullPostId, 
...
// Export prisma client instance (Nếu cần dùng cho các thao tác khác)
